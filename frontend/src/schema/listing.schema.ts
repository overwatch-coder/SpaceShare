...
export const initialListingSchema = z.object({
...
export const updateListingSchema = initialListingSchema.partial();

export const listingSchema = initialListingSchema.superRefine((values, ctx) => {
